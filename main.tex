...
% Anhang -> Literaturverzeichnis, Nummerierung in Römisch, folgend auf Textteil
...
pdfauthor={\name},
pdfkeywords={akad, assignment, pdf, REG23, SPS, CODESYS}
%---------------------------------------------------------
...
% Grundlagen
\include{Text/grundlagen}

% Hauppteil
\include{Text/hauptteil}

% Schluss
\include{Text/schluss}
